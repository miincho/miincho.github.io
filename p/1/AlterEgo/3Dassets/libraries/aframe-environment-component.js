	...
	if (typeof AFRAME === 'undefined') {
	  ...
	  AFRAME.registerComponent('environment', {
		schema: {
		  ...
		  groundTexture: { default: 'url(https://cdn.glitch.global/bd5c3edd-7235-4357-9976-fcbca2f6c7a4/green%20grass-min.png?v=1701571814481)', oneOf:['none', 'url(https://cdn.glitch.global/bd5c3edd-7235-4357-9976-fcbca2f6c7a4/green%20grass-min.png?v=1701571814481)', 'checkerboard', 'squares', 'walkernoise']},
		  groundColor:  {type: 'color', default: '#5a511c'},
		  groundColor2: {type: 'color', default: '#5a511c'},
		...
		presets: {
		  'none' : {},
		  'default' : {active: true, seed: 1, skyType: 'gradient', skyColor: '#170104', horizonColor: '#000000', lighting: 'distant', lightPosition: { x: -0.11, y: 1, z: 0.33}, fog: 0.78, flatShading: false, playArea: 1, ground: 'hills', groundYScale: 3, groundTexture: 'https://cdn.glitch.global/bd5c3edd-7235-4357-9976-fcbca2f6c7a4/green%20grass-min.png?v=1701571814481', groundColor: '#000000', groundColor2: '#000000', dressing: 'none', dressingAmount: 10, dressingColor: '#795449', dressingScale: 1, dressingVariance: { x: 0, y: 0, z: 0}, dressingUniformScale: true, dressingOnPlayArea: 0, grid: 'none', gridColor: '#ccc', shadow: false, stars: true,},
		  'contact': {active: true, seed: 14, skyType: 'gradient', skyColor: '#478d54', horizonColor: '#b696cb', lighting: 'distant', lightPosition: { x: 0, y: 2.01, z: -1}, fog: 0.8, flatShading: false, playArea: 1, ground: 'spikes', groundYScale: 4.91, groundTexture: 'https://cdn.glitch.global/bd5c3edd-7235-4357-9976-fcbca2f6c7a4/greenground.png?v=1701509928586', groundColor: '#2e455f', groundColor2: '#694439', dressing: 'apparatus', dressingAmount: 7, dressingColor: '#657067', dressingScale: 20, dressingVariance: { x: 20, y: 20, z: 20}, dressingUniformScale: true, dressingOnPlayArea: 0, grid: '1x1', gridColor: '#478d54', shadow: false},
